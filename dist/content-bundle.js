...
/***/ function(module, exports, __webpack_require__) {
	...
	var SELECTOR_SERIES_NAME = '.movie_navigation .titles span a';
	...
	var onReady = function onReady() {
	  (0, _localStorageHelper.getFromStorage)('collection').then(function (_ref) {
	    ...
	    (0, _jquery2.default)(SELECTOR_EPISODE).click(handleClick);
	  });
	};
	...
	var handleClick = function handleClick(event) {
	  ...
	  // create new series
	  var newSeries = new _objects.Series(seriesName);

	  clickedEpisodeLink = (0, _jquery2.default)(this).find('a').attr('href');

	  (0, _jquery2.default)('.tv_episode_item:not(".transp2")').each(function () {
	    urls.push({
	      url: (0, _jquery2.default)(this).find('a').attr('href'),
	      episodeName: (0, _jquery2.default)(this).find('.tv_episode_name').text()
	    });
	  });
	  ...
	  urls.sort(function (a, b) {
	    ...
	    if (aSeasonNumber != bSeasonNumber) return aSeasonNumber - bSeasonNumber;else return aEpisodeNumber - bEpisodeNumber;
	  });
	  ...
	  for (var i = 0; i < urls.length; i++) {
	    ...
	    if (url.url.split('/')[2].split('-')[1] != currentSeason) {
	      currentSeason++;
	      newSeries.seasons.push(new _objects.Season(currentSeason + 1));
	    }

	    var episodeToAdd = new _objects.Episode(url.episodeName ? url.episodeName.split('-')[1].trim(0, 1) : '', url.url.split('/')[2].split('-')[3], url.url.split('/')[2].split('-')[1], url);
